...
global KEY
KEY = "37b69150-771d-11ea-ad9d-e3973575338f17416e1a-0e2f-41f3-bc60-2eb8f1779038"
...
def learn_from_this(winner, boardhistory, winnerdecisions):
    ...
    print("The computer will now learn from %s's experience!\n" % (winner))
    for idx in range(len(winnerdecisions)):
        print("At the start of move %d the board looked like this:" % (idx + 1))
        print(boardhistory[idx])
        print("And %s decided to put their mark in %s\n" % (winner, winnerdecisions[idx]))
